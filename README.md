...
To access lwdataexplorer datasets, your ETN credentials (userid and password) must be filled in a .Renviron file. See this tutorial to configure your credentials: https://inbo.github.io/etn/articles/authentication.html
